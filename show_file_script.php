...
<!-- <img id = "display-image" src = "dataStorage/<?=$fetched_result_display['file'];?>" onerror = "this.style.display = 'none'"/> -->
        ...
        <div id = "heading"><?=$fetched_result_display['comment']?></div> 
        <iframe id = "pdf-file" src = "dataStorage/<?=$fetched_result_display['file'];?>" title="pdf or txt files" onerror = "this.style.display = 'none';"></iframe>
